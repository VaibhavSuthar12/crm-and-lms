...
--
-- Host: localhost:3306
-- Generation Time: Jun 29, 2026 at 03:15 PM
...
CREATE TABLE `leads` (
  ...
  `status` enum('New','Contacted','Qualified','Proposal Sent','Won','Lost') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'New',
...
ALTER TABLE `activities`
  ...
  ADD KEY `activities_lead_id_created_at_index` (`lead_id`,`created_at`),
  ADD KEY `activities_customer_id_created_at_index` (`customer_id`,`created_at`);
...
ALTER TABLE `activities`
  ...
  ADD CONSTRAINT `activities_lead_id_foreign` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE SET NULL,
...
ALTER TABLE `customers`
  ...
  ADD CONSTRAINT `customers_lead_id_foreign` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `notes`
  ADD CONSTRAINT `notes_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `notes_lead_id_foreign` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE SET NULL,
